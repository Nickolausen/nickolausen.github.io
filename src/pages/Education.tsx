...
function Education() 
{
    return (
        <section id='education' className="pt-10">
                ...
                <div className={styles.grid_cell + " row-span-7"}>
                    ...
                    <table>
                        <tr>
                            ...
                            <td className="text-xl">000/000</td>
                        </tr>
                        <tr>
            ...
            <h2 className="text-4xl font-bold uppercase pt-20">Technical Knowledge</h2>
            <div className="grid grid-cols-2 pt-10">
                <div className="flex flex-wrap flex-col content-center"> 
                    ...
                    <h3 className="mt-5 text-2xl">Learnt from School</h3>
                </div> 
                <div className="flex flex-wrap flex-col content-center">
                    ...
                    <h3 className="mt-5 text-2xl">Self-taught</h3>
                </div>
            </div>
        </section>
    )
